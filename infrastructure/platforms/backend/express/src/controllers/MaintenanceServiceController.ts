...
export class MaintenanceController {
    ...
    async createMaintenance(req: Request, res: Response): Promise<void> {
        try {
            ...
            console.error("Erreur dans MaintenanceController.createMaintenance:", error);
    ...
    async getAllMaintenance(req: Request, res: Response): Promise<void> {
        try {
            ...
            console.error("Erreur dans MaintenanceController.getAllMaintenance:", error);
            res.status(500).json({ error: "Erreur interne" });
        }
    }
    ...
    async updateMaintenance(req: Request, res: Response): Promise<void> {
        try {
            ...
            console.error("Erreur dans MaintenanceController.updateMaintenance:", error);
            res.status(500).json({ error: "Erreur interne" });
        }
    }
    ...
    async removeMaintenance(req: Request, res: Response): Promise<void> {
        try {
            ...
            console.error("Erreur dans MaintenanceController.removeMaintenance:", error);
            res.status(500).json({ error: "Erreur interne" });
        }
    }
    ...
    async getMaintenanceByBike(req: Request, res: Response): Promise<void> {
        try {
            ...
            console.error("Erreur dans MaintenanceController.getMaintenanceByBike:", error);
            res.status(500).json({ error: "Erreur interne" });
        }
    }
