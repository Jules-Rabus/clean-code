...
export const CreateCompanyUseCaseProvider = {
  ...
  useFactory: (companyRepository: MongooseCompanyRepository) => new CreateCompanyUseCase(companyRepository),
  inject: [MongooseCompanyRepository],
};

export const RemoveCompanyUseCaseProvider = {
  provide: RemoveCompanyUseCase,
  useFactory: (companyRepository: MongooseCompanyRepository) => new RemoveCompanyUseCase(companyRepository),
  inject: [MongooseCompanyRepository],
};

export const UpdateCompanyUseCaseProvider = {
  provide: UpdateCompanyUseCase,
  useFactory: (companyRepository: MongooseCompanyRepository) => new UpdateCompanyUseCase(companyRepository),
  inject: [MongooseCompanyRepository],
};

export const FindOneCompanyUseCaseProvider = {
  provide: FindOneCompanyUseCase,
  useFactory: (companyRepository: MongooseCompanyRepository) => new FindOneCompanyUseCase(companyRepository),
  inject: [MongooseCompanyRepository],
};

export const FindAllCompanyUseCaseProvider = {
  provide: FindAllCompanyUseCase,
  useFactory: (companyRepository: MongooseCompanyRepository) => new FindAllCompanyUseCase(companyRepository),
  inject: [MongooseCompanyRepository],
};

export const SearchByNameUseCaseProvider = {
  provide: SearchByNameUseCase,
  useFactory: (companyRepository: MongooseCompanyRepository) => new SearchByNameUseCase(companyRepository),
  inject: [MongooseCompanyRepository],
};
