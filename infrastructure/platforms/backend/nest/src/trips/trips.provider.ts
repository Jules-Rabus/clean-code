...
const CreateTripUseCaseProvider = {
  ...
  useFactory: (tripRepository: SequelizeTripRepository) => new CreateTripUseCase(tripRepository),
  inject: [SequelizeTripRepository],
};

const FindOneTripUseCaseProvider = {
  provide: FindOneTripUseCase,
  useFactory: (tripRepository: SequelizeTripRepository) => new FindOneTripUseCase(tripRepository),
  inject: [SequelizeTripRepository],
};

const FindAllTripUseCaseProvider = {
  provide: FindAllTripUseCase,
  useFactory: (tripRepository: SequelizeTripRepository) => new FindAllTripUseCase(tripRepository),
  inject: [SequelizeTripRepository],
};

const RemoveTripUseCaseProvider = {
  provide: RemoveTripUseCase,
  useFactory: (tripRepository: SequelizeTripRepository) => new RemoveTripUseCase(tripRepository),
  inject: [SequelizeTripRepository],
};

const UpdateTripUseCaseProvider = {
  provide: UpdateTripUseCase,
  useFactory: (tripRepository: SequelizeTripRepository) => new UpdateTripUseCase(tripRepository),
  inject: [SequelizeTripRepository],
};
