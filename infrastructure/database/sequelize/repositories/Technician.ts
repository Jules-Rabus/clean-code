...
export default class SequelizeTechnicianRepository implements TechniciansRepository {
    ...
    async update(identifier: string, technician: Partial<Technician>): Promise<Technician | null> {
    ...
    async findAll(): Promise<Technician[]> {
        ...
        return technicians.map((technician) => Technician.fromSequelizeModel(technician));
    }
